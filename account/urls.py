...
urlpatterns = [  
    ...
    path('verification-of-email/<str:uidb64>/<str:token_value>/', views.verification_of_email, name='verification-of-email'),
    ...
    # 2) Succes message stating that a password reset email was sent
    ...
    # 2) Succes message stating that our password was reset
